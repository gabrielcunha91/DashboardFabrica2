...
with st.container(border=True):
  ...
  with col1:
    ...
    with col4:
      classificacoes_1_selecionadas = st.multiselect(label='Selecione Classificação Contábil 1', options=classificacoes1)
    ...
    with col5:
      ...
      classificacoes_2_selecionadas = st.multiselect(label='Selecione Classificação Contábil 2', options=classificacoes2)
